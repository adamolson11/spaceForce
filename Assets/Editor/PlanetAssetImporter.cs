...
public class PlanetAssetImporter : EditorWindow
{
    ...
    private static readonly PlanetData[] planets = new PlanetData[]
    {
        ...
        new PlanetData("Europa", "https://solarsystem.nasa.gov/system/resources/detail_files/2426_europa_2k.jpg", 
            0.6f, new Vector3(62f, 0f, 3f)),
        new PlanetData("Saturn", "https://solarsystem.nasa.gov/system/resources/detail_files/761_PIA11141.jpg", 
            7f, new Vector3(80f, 0f, 0f)),
        new PlanetData("Titan", "https://solarsystem.nasa.gov/system/resources/detail_files/16883_PIA20016.jpg", 
            0.8f, new Vector3(82f, 0f, 4f)),
